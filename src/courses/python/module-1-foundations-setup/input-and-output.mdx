...
description: >-
  រៀនពីរបៀបអាន user input, បង្កើត formatted output, និង convert ស្រួលរវាង data
  types របស់ Python។
objectives:
...
quiz:
  - question: What type does input() always return?
    ...
    correctAnswer: 2
    explanation: >-
      input() always returns a string, regardless of what the user types. You
      must explicitly convert it with int(), float(), etc.
  - question: What does int("3.7") return?
    ...
    correctAnswer: 3
    explanation: >-
      int() cannot parse a string containing a decimal point directly. You need
      int(float("3.7")) to get 3.
---
