...
title: Python គឺអ្វី?
description: >-
  សេចក្តីណែនាំអំពី Python — វាជាអ្វី, ហេតុអ្វីបានជាវាសំខាន់,
  ហើយហេតុអ្វីបានជាវាជាភាសាដែលគេជ្រើបំផុតសម្រាប់ data science និង AI។
objectives:
...
quiz:
  - question: Which of the following is a key reason Python is popular in data science?
    ...
    correctAnswer: 1
    explanation: >-
      Python's popularity in data science stems largely from its rich ecosystem
      of libraries like NumPy, Pandas, Scikit-learn, and TensorFlow.
