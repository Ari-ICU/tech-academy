...
Python Ecosystem
│
├── 1. Built-in (មានស្រាប់ មិនបាច់ Import)
│     ├── print(), len(), int()
│
├── 2. Standard Library (មកជាមួយ Python តែត្រូវ Import សិនទើបប្រើបាន)
│     ├── math
│     ├── os
│     └── json
│
└── 3. Third-party Packages (ត្រូវទាញយកពីអុីនធឺណិតតាមរយៈ pip)
      ├── numpy (សម្រាប់គណិតវិទ្យា Data Science)
      ├── pandas (សម្រាប់វិភាគទិន្នន័យ)
      ├── requests (សម្រាប់ទាញយកទិន្នន័យពី Website)
      └── fastapi (សម្រាប់បង្កើត Web API)
```
