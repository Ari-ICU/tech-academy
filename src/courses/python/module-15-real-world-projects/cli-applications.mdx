...
description: អនុវត្តចំណេះដឹង Python របស់អ្នកដោយបង្កើតកម្មវិធី Command-Line Interface (CLI) ដែលមានប្រយោជន៍សម្រាប់ការងារប្រចាំថ្ងៃ ដោយប្រើប្រាស់បណ្ណាល័យ argparse ដ៏មានអានុភាព។
objectives:
...
order: 1
quiz:
  - question: ហេតុអ្វីបានជាអ្នកជំនាញ IT និង Data Scientists ភាគច្រើនចូលចិត្តប្រើប្រាស់កម្មវិធី CLI (Command Line Interface) ជាងកម្មវិធី GUI (ដែលមានប៊ូតុងចុច)?
    options:
      - ព្រោះកម្មវិធី CLI មានពណ៌ស្អាតជាង GUI
      - ព្រោះកម្មវិធី CLI ងាយស្រួលសរសេរ និងងាយស្រួលបញ្ជាឱ្យដំណើរការដោយស្វ័យប្រវត្តិ (Automation) តាមរយៈ Scripts ជាងកម្មវិធី GUI ដែលតម្រូវឱ្យមានមនុស្សអង្គុយចុច
      - ព្រោះកម្មវិធី GUI លែងមានអ្នកប្រើប្រាស់ទៀតហើយ
      - ព្រោះកម្មវិធី CLI អាចដំណើរការបានតែលើ Linux ប៉ុណ្ណោះ
    correctAnswer: 2
    explanation: 'កម្មវិធី CLI អាចត្រូវបានបញ្ជាដោយកូដផ្សេងទៀត (ឧទាហរណ៍ បញ្ជាឱ្យរត់រៀងរាល់ម៉ោង១២យប់) ដែលធ្វើឱ្យវាក្លាយជាគ្រឹះនៃការធ្វើស្វ័យប្រវត្តិកម្ម (Automation)។ ចំណែក GUI ទាមទារឱ្យមានមនុស្សអង្គុយចុច Mouse ទើបដើរ។'
  - question: នៅក្នុងបណ្ណាល័យ argparse តើអ្វីជាភាពខុសគ្នារវាង Positional Argument និង Optional Argument (Flag)?
    options:
      - គ្មានភាពខុសគ្នាទេ
      - Positional គឺតម្រូវឱ្យមានជាដាច់ខាត ចំណែក Optional (ដែលផ្តើមដោយសញ្ញា - ឬ --) អាចមានឬអត់ក៏បាន
      - Positional ជាអក្សរ រីឯ Optional ជាលេខ
      - Optional គឺតម្រូវឱ្យមានជាដាច់ខាត
    correctAnswer: 2
    explanation: 'Positional argument គឺត្រូវតែផ្តល់ឱ្យតាមលំដាប់លំដោយ (ឧ. copy file1.txt file2.txt)។ ចំណែក Optional argument (Flag) តែងតែផ្តើមដោយសញ្ញាដក (ឧ. --verbose ឬ -v) ហើយអ្នកអាចដាក់វានៅទីណាក៏បាន ឬមិនបាច់ដាក់ក៏បាន។'
---
