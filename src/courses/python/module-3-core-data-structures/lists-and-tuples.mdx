...
description: >-
  ចាប់ផ្តើមជាម្ចាស់ជាមួយ sequence types សំខាន់ពីររបស់ Python — list
  ដែលអាចប្តូរបាន និង tuple ដែលប្តូរមិនបាន — រួមទាំង operations, methods,
  និងពេលណាគួរជ្រើនីមួយ។
objectives:
  - 'បង្កើត, index, slice, និង mutate lists'
  - យល់ពីភាពខុសគ្នារវាង list និង tuple និងពេលណាគួរប្រើនីមួយ
  - >-
    ប្រើ list methods ដោយទុកចិត្តសម្រាប់ appending, inserting, sorting, និង
    searching
order: 1
quiz:
  - question: What is the key difference between a list and a tuple in Python?
    ...
    correctAnswer: 1
    explanation: >-
      The fundamental distinction is mutability — lists can be modified in
      place, tuples cannot.
  - question: What does list.pop() do when called with no arguments?
    ...
    correctAnswer: 1
    explanation: >-
      list.pop() removes and returns the last element. list.pop(i) removes and
