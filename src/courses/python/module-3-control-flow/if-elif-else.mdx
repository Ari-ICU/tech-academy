...
```text
អ្នកប្រើប្រាស់វាយបញ្ចូលពាក្យសម្ងាត់
        │
        ▼
ត្រឹមត្រូវឬទេ?
   │
...
Stop   មានអត្តសញ្ញាណប័ណ្ណ? (Has ID?)
 ...
 ចូលបាន (Enter)  សូមបង្ហាញ ID របស់អ្នក
```
...
អនុម័ត   ពិនិត្យមើលឥណទាន (Credit)

             │

       ┌─────┴─────┐

      ល្អ (Good)     អាក្រក់ (Bad)

       │           │

       ▼           ▼

    អនុម័ត (Approve)  បដិសេធ (Reject)
```
