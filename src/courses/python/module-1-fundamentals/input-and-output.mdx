...
```text
Program ចាប់ផ្តើមរត់
        │
        ▼
បង្ហាញអត្ថបទសួរ (Prompt)
        │
        ▼
រង់ចាំរហូតអ្នកប្រើប្រាស់វាយអក្សរ
        │
        ▼
អ្នកប្រើប្រាស់ចុច Enter
        │
        ▼
បញ្ជូនត្រឡប់មកវិញជា String (អត្ថបទ)
        │
        ▼
រក្សាទុកក្នុង Variable
```
