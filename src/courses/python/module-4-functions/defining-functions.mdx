...
ហៅឱ្យដើរ (Call)
↓
ចម្លងតម្លៃ Arguments (Arguments copied)
↓
រត់កូដខាងក្នុង (Body executes)
↓
បញ្ជូនតម្លៃ (Return)
↓
បញ្ចប់ដំណើរការ (Function ends)
```
