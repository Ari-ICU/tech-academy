          ...
          {displayCourses.map((course) => {
            ...
            return (
              <Link
                ...
                className="group relative bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 hover:border-blue-300 dark:hover:border-blue-700 hover:shadow-xl cursor-pointer transition-all duration-300 overflow-hidden flex flex-col"
              >
                {/* Gradient top bar */}
